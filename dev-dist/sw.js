...
define(['./workbox-97ee75a3'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    "url": "/index.html",
    "revision": "0.mhkplfocj4"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("/index.html"), {
    allowlist: [/^\/$/],
    denylist: [/^\/api/, /\.(?:png|jpg|jpeg|svg|gif|webp|js|css)$/]
  }));
  ...
  workbox.registerRoute(/^https:\/\/.*\/api\/proxy$/i, new workbox.NetworkOnly(), 'GET');
