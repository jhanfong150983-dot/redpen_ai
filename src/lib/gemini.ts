...
勾選題（最容易腦補！）：
- 題目：「台灣位於哪一洲？ □亞洲 □歐洲 □非洲 □美洲」，四個選項都沒有打勾/圈選痕跡
  → 輸出「未作答」（❌ 即使人人都知道是亞洲，也不可腦補「亞洲」）
- 題目：「首都在台北的國家是？ □日本 □中華民國 □韓國」，沒有任何標記
  → 輸出「未作答」（❌ 不可腦補「中華民國」）
- ⚠️ 判斷標準：有打勾/圈選/劃記 = 有作答；完全沒有任何標記 = 未作答
...
勾選題：
- 題目：「□A □B □C □D」，四個選項都沒有任何打勾/圈選/劃記痕跡
  → ❌ 不可腦補「A」或任何選項，必須輸出「未作答」
- 判斷標準：
  - 有打勾/圈選/劃記痕跡 → 輸出該選項（如「A」「B」）
  - 完全沒有任何標記 → 輸出「未作答」
